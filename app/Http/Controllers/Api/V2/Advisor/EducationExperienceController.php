...
class EducationExperienceController extends Controller
{
    ...
    public function add(Request $request){
        ...
        if(!empty($request->user()->progress)){
            ...
            if(array_key_exists("my_journey", $progress)){
                ...
                $educationExperience->start_date = $request->start_date?Carbon::parse($request->start_date)->format('Y-m-d H:i:s'):null;
                $educationExperience->graduation_year = $request->graduation_year?Carbon::parse($request->graduation_year)->format('Y-m-d H:i:s'):null;
                ...
                $educationExperience->ask_me_about = $request->ask_me_about;
        ...
        if($education->first())
        {
            ...
            $education->update(
                [
                    ...
                    'graduation_year'=>$request->graduation_year?Carbon::parse($request->graduation_year)->format('Y-m-d H:i:s'):null,
    ...
    public function addJourneyHeadline(Request $request)
    {
        $request->validate([
        ...
        return $this->respondSuccess('Deadline Added Successfully !' ,201);
    }
}
