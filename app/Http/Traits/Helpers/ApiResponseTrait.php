...
trait ApiResponseTrait
{
    ...
    protected function respondSuccessWithData($data, $message = null, $statusCode = 200, $headers = [])
{
        return $this->apiResponse(
            [
                'success' => true,
     ...
     * @return JsonResponse
     */
    protected function respondSuccess($message = '',$statusCode=200)
    {
        return $this->apiResponse(['success' => true, 'statusCode' => $statusCode, 'message' => $message]);
    }
    ...
    /**
     * Respond with not content Owner.
     *
     * @param string $message
     *
     * @return JsonResponse
     */
    protected function respondNotContentOwner($message = 'Unauthorized',$statusCode = 403)
    {
        return $this->apiResponse(['success' => false,'statusCode' => $statusCode, 'message' => $message], 200);
    }
     ...
     * @return JsonResponse
     */
    protected function respondNoContent($message = 'No Content Found',$statusCode = 200)
    {
        return $this->apiResponse(['success' => false,'statusCode' => $statusCode, 'message' => $message], 200);
    }
     ...
     * @return JsonResponse
     */
    protected function respondUnAuthorized($message = 'Unauthorized',$statusCode = 401)
    {
     ...
     * @return JsonResponse
     */
    protected function respondForbidden($message = 'Forbidden',$statusCode=403)
    {
        return $this->respondError($message, $statusCode);
    }
     ...
     * @return JsonResponse
     */
    protected function respondNotFound($message = 'Not Found',$statusCode = 404)
    {
        return $this->respondError($message, $statusCode);
    }
     ...
     * @return JsonResponse
     */
    protected function respondInternalError($message = 'Internal Error',$statusCode = 500)
    {
        return $this->respondError($message, $statusCode);
    }

    protected function respondValidationErrors(ValidationException $exception,$statusCode = 422)
    {
        return $this->apiResponse(
            [
                'success' => false,
