...
<div class="mail-messages" style="width: 640px; background: #FFFFFF; margin: 0px auto; padding: 55px; border: 1px solid #ccc;">
  ...
  <h2 style="font-weight: 700; font-size: 26px; line-height: 24px; color: #313438; margin-bottom: 25px; font-family: 'Inter', sans-serif; margin-top: 0px;">✅Your meeting is confirmed!</h2>
   <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif; margin-top: 0px;">Hi {{ucfirst($detailsAdvisee['advisee_name'])}},</p>
   <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif;">Your meeting with <strong>{{$detailsAdvisee['advisor_name']}} {{$detailsAdvisee['advisor_last_name']}}</strong> for <strong>{{$detailsAdvisee['meeting_type']}}</strong> has been confirmed for <strong>{{$detailsAdvisee['confirm_time']}}.</strong> You will receive a calendar invite with a Zoom link shortly. </p>
  ...
  <div class="mail-img-desc" style="">
    ...
    width: 75px;height: 75px;border-radius: 100%;padding: 2px; display:inline-block;vertical-align: top;">
      <img style="display: block;border: 2px solid #fff;border-radius: 100%;max-width: 100%;width: 71px;height: 71px;" src="{{$message->embed(public_path($detailsAdvisee['advisor_profile']))}}" class="img-fluid" alt="">
    </div>
    <div class="mail-img-sec" style="width: 80%;display: inline-block;padding-left: 20px;">
      <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif; margin-top: 0px;">{{$detailsAdvisee['message']}}</p>
    </div>
  </div>
  ...
  <div style="border: 1px solid #E4E7EC;margin-bottom: 23px;"></div>
   ...
   <div class="verify-btn" style="margin-bottom: 24px;">
    <a href="{{$detailsAdvisee['redirect_url']}}" class="btn btn-info" style="border-radius: 8px !important; background: #458DFC !important; outline: none !important;    box-shadow: none !important; border: none !important; font-weight: 500; font-size: 16px; line-height: 26px; padding: 9px 19px;text-decoration: none; color: #fff;display: block; font-family: 'Inter', sans-serif; text-align: center;">View Meeting Details ></a>
   </div>
   <div class="mail-thanks">
    <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif; margin-top: 0px;">If you need to contact {{$detailsAdvisee['advisee_name']}}, reschedule or cancel this meeting, click the button above. Happy connecting!</p>
