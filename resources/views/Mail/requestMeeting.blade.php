...
<div class="mail-messages" style="width: 640px; background: #FFFFFF; margin: 0px auto; padding: 55px; border: 1px solid #ccc;">
  ...
  <div class="mail-desc">
    <h2 style="font-weight: 700; font-size: 26px; line-height: 24px; color: #313438; margin-bottom: 25px; font-family: 'Inter', sans-serif; margin-top: 0px;"><img src="{{asset('assets/images/mail-icon.png')}}" class="img-fluid" alt="" style="max-width: 100%;height: auto;display: inline-block;margin-right: 15px;vertical-align: bottom;">New Meeting Request</h2>
    <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif; margin-top: 0px;">Hi {{ucfirst($details['advisor_name'])}},</p>
    <p style="font-weight: 400; font-size: 16px; line-height: 24px; color: #344054; margin-bottom: 24px; font-family: 'Inter', sans-serif; margin-top: 0px;">You have a new meeting request from <strong>{{$details['advisee_fullname']}}</strong> for <strong>{{$details['meeting_type']}}:</strong></p>
  </div>
  ...
  <div class="mail-img-desc">
    ...
    <div class="mail-img" style="background: linear-gradient(180deg, #67C3F3 0%, #458DFC 100%); width: 75px;height: 75px;border-radius: 100%;padding: 2px;display:inline-block;vertical-align: top;">
      ...
      <img style="display: block;border: 2px solid #fff;border-radius: 100%;max-width: 100%;width: 71px;height: 71px;" src="{{$message->embed(public_path($details['advisee_profile']))}}" class="img-fluid" alt="">
    </div>
