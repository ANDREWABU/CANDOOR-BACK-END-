<style>
    ...
    .partnerWrap-1 p, .partnerWrap-1 p a {
        font-weight: normal;
        font-size: 20px;
        line-height: 30px;
        text-align: center;
    ...
    .networkWrapPartner h6{
        font-weight: 600;
        font-size: 30px;
        line-height: 38px;
        color: #101828;
    }
    .networkWrapPartner p{
        font-weight: normal;
        font-size: 18px;
        line-height: 28px;
        color: #667085;
    }
    .networkWrapPartner ul{
        padding-top: 10px;
    }
    .networkWrapPartner ul li{
        list-style-type: none;
        position: relative;
    }
    .networkWrapPartner ul li p {
        padding-left: 30px;
    }
    .networkWrapPartner .tick-icon{
        position: absolute;
        left: -15px;
        top: 2px;
    }
