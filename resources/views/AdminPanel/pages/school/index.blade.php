...
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header space-between">
                        <h4>Schools</h4>
                        <button class="btn btn-gradient" id="AddSchoolp" data-bs-toggle="modal" data-bs-target="#addSchool">Add 
                            School</button>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu shadow-lg" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <li>
                                                        ...
                                                        <form method="POST" action="{{ route('schools.destroy',[$item->id]) }}">
                                                            @method('DELETE')
                                                            @csrf
    ...
    <div class="modal fade show" id="addSchool" tabindex="-1" aria-labelledby="addSchoolModal" aria-modal="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" id="addSchoolForm" action="{{ route('schools.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" value="{{ old('name') }}" placeholder="Enter School Name" id="name" name="name"
    ...
    {{-- Update  School Model --}}
    <div class="modal fade show" id="updateSchool" tabindex="-1" aria-labelledby="exampleModaluser" aria-modal="true"
        role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModaluser">Update School</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="progress" style="height: 2px">
                    <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 100%;"
                ...
                <form method="POST" id="updateSchoolForm" action="" >
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Scchool Name" id="update_name" name="update_name"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.edit', function() {
                ...
                let route= "{{ route('schools.show', ":id") }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(response.status === 'success')
                        {
                           ...
                           $("#updateSchoolForm").attr('action',response.data.action);
                        }
                    },
